...
In that path, the Client transfers USDC directly to the Server’s Solana address. The
Receipt Service verifies the mint, recipient and exact amount before issuing
a receipt.
