...
_Prove you've done the work before claiming results._
...
_Does this diff contain only what was asked for?_
...
_Can you explain what this code actually does, line by line?_
...
_Does this change break something it doesn't touch?_
...
_What happens when this code is attacked or when its dependencies fail?_
...
_Is this code going to be maintainable as the system grows?_
...
| Future reader test            | If someone opens this file in 3 months, will they understand what's happening and _why_ without reading the conversation that produced it? Are non-obvious decisions explained where they're made? |
...
_Do the tests actually prove the code works, or do they just exist?_
...
_Does this change make the overall system better or worse?_
...
_What should be in this diff but isn't?_
